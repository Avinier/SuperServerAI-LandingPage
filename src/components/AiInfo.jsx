...
const AiInfo = () => {
  ...
  return (
    <section className="py-10 md:py-20 px-6 md:px-8 lg:px-20 relative bg-secondary overflow-hidden rounded-tl-[60px] md:rounded-tl-[120px] rounded-bl-[60px] md:rounded-bl-[120px]">
